...
static const char mblink_css[] =
    ...
    "button, button label, dropdown, entry { font-family: \"MB Corpo S Title WEB\"; }"
    ...
    ".link-toolbar-button, .link-toolbar-button label { font-family: \"MB Corpo S Title WEB\"; font-weight: 700; }"
    ".link-link-button, .link-link-button label { background: #d7dde2; color: #111418; border-radius: 10px; font-family: \"MB Corpo S Title WEB\"; font-weight: 700; }"
    ".link-save-session-button, .link-save-session-button label { font-family: \"MB Corpo S Title WEB\"; font-weight: 700; }"
    ".link-connection-status { font-family: \"MB Corpo S Title WEB\"; font-weight: 700; }"
    ".link-about-button, .link-about-button label { font-family: \"MB Corpo S Title WEB\"; font-weight: 700; }"
