...
The current iPhone bridge still keeps its stream in memory for sharing; durable file-backed long-session storage remains a later product hardening task, not a change to the portable recorder contract.
