    ...
    uint64_t first_due_ms)
{
    static const MblinkStandardSchedule plan[] = {
        ...
        { 0x23U, 500U,  MBLINK_SCHEDULER_PRIORITY_HIGH },
        { 0x7aU, 750U,  MBLINK_SCHEDULER_PRIORITY_HIGH },
        { 0x7cU, 1000U, MBLINK_SCHEDULER_PRIORITY_HIGH },
        ...
        { 0x2cU, 750U,  MBLINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x2dU, 1000U, MBLINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x5eU, 1000U, MBLINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x78U, 1000U, MBLINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x3cU, 1500U, MBLINK_SCHEDULER_PRIORITY_NORMAL },
        { 0x05U, 1500U, MBLINK_SCHEDULER_PRIORITY_LOW },
        { 0x0fU, 1500U, MBLINK_SCHEDULER_PRIORITY_LOW },
        { 0x33U, 2000U, MBLINK_SCHEDULER_PRIORITY_LOW },
        { 0x42U, 2000U, MBLINK_SCHEDULER_PRIORITY_LOW },
        { 0x46U, 3000U, MBLINK_SCHEDULER_PRIORITY_LOW },
        { 0x5cU, 1500U, MBLINK_SCHEDULER_PRIORITY_LOW }
    };
    size_t index;
