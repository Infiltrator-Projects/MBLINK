...
static const MblinkMercedesDidLabDefinition mercedes_did_lab[] = {
    ...
    {
        "mercedes.vehicle.engine.state",
        "Engine state",
        "Mercedes backend semantic / cross-model research target",
    ...
    {
        "mercedes.vehicle.ignition.state",
        "Ignition state",
        "Mercedes backend semantic / cross-model research target",
    ...
    {
        "mercedes.vehicle.aftertreatment.filter_particle_loading",
    ...
    {
        "mercedes.vehicle.aftertreatment.adblue_level",
        "AdBlue level",
        "Mercedes backend semantic / cross-model research target",
        MBLINK_MERCEDES_MODULE_OTHER,
        MBLINK_MERCEDES_DID_LAB_CONCEPT_ONLY,
    ...
    {
        "mercedes.vehicle.fuel.tank_level",
        ...
        false, 0U, 0U, MBLINK_MERCEDES_DID_LAB_UNSIGNED_BIG_ENDIAN,
        0.0, 0.0, "%",
        "mercedes.backend.liquid_tank_level",
        "Mercedes MBSDK proves this backend semantic exists in the connected-vehicle model. Exact ECU, protocol mapping, DID, encoding and model/year applicability remain intentionally unmapped.",
        "https://github.com/mercedes-benz/MBSDK-CarKit-iOS/blob/master/MBCarKit/MBCarKit/Models/DTO/VehicleStatusDTO.swift"
    },
    {
        "mercedes.vehicle.fuel.range",
        "Liquid fuel range",
        "Mercedes backend semantic / cross-model research target",
        MBLINK_MERCEDES_MODULE_OTHER,
        MBLINK_MERCEDES_DID_LAB_CONCEPT_ONLY,
        false, 0U, 0U, MBLINK_MERCEDES_DID_LAB_UNSIGNED_BIG_ENDIAN,
        0.0, 0.0, "distance",
        "mercedes.backend.liquid_range",
        "Mercedes MBSDK proves this backend semantic exists in the connected-vehicle model. Exact ECU, protocol mapping, DID, encoding and model/year applicability remain intentionally unmapped.",
        "https://github.com/mercedes-benz/MBSDK-CarKit-iOS/blob/master/MBCarKit/MBCarKit/Models/DTO/VehicleStatusDTO.swift"
    },
    {
        "mercedes.vehicle.fuel.consumption_since_reset",
        "Liquid consumption since reset",
        "Mercedes backend semantic / cross-model research target",
        MBLINK_MERCEDES_MODULE_OTHER,
        MBLINK_MERCEDES_DID_LAB_CONCEPT_ONLY,
        false, 0U, 0U, MBLINK_MERCEDES_DID_LAB_UNSIGNED_BIG_ENDIAN,
        0.0, 0.0, "consumption",
        "mercedes.backend.liquid_consumption_reset",
        "Mercedes MBSDK proves this backend semantic exists in the connected-vehicle model. Exact ECU, protocol mapping, DID, encoding and model/year applicability remain intentionally unmapped.",
        "https://github.com/mercedes-benz/MBSDK-CarKit-iOS/blob/master/MBCarKit/MBCarKit/Models/DTO/VehicleStatusDTO.swift"
    },
    {
        "mercedes.vehicle.fuel.consumption_since_start",
        "Liquid consumption since start",
        "Mercedes backend semantic / cross-model research target",
        MBLINK_MERCEDES_MODULE_OTHER,
        MBLINK_MERCEDES_DID_LAB_CONCEPT_ONLY,
        false, 0U, 0U, MBLINK_MERCEDES_DID_LAB_UNSIGNED_BIG_ENDIAN,
        0.0, 0.0, "consumption",
        "mercedes.backend.liquid_consumption_start",
        "Mercedes MBSDK proves this backend semantic exists in the connected-vehicle model. Exact ECU, protocol mapping, DID, encoding and model/year applicability remain intentionally unmapped.",
        "https://github.com/mercedes-benz/MBSDK-CarKit-iOS/blob/master/MBCarKit/MBCarKit/Models/DTO/VehicleStatusDTO.swift"
    },
    {
        "mercedes.vehicle.odometer",
        "Odometer",
        "Mercedes backend semantic / cross-model research target",
        MBLINK_MERCEDES_MODULE_OTHER,
        MBLINK_MERCEDES_DID_LAB_CONCEPT_ONLY,
        false, 0U, 0U, MBLINK_MERCEDES_DID_LAB_UNSIGNED_BIG_ENDIAN,
        0.0, 0.0, "distance",
        "mercedes.backend.odometer",
        "Mercedes MBSDK proves this backend semantic exists in the connected-vehicle model. Exact ECU, protocol mapping, DID, encoding and model/year applicability remain intentionally unmapped.",
        "https://github.com/mercedes-benz/MBSDK-CarKit-iOS/blob/master/MBCarKit/MBCarKit/Models/DTO/VehicleStatusDTO.swift"
    },
    {
        "mercedes.vehicle.service.interval_days",
    ...
    {
        "mercedes.vehicle.service.interval_distance",
    ...
    {
        "mercedes.vehicle.electrical.starter_battery_state",
    ...
    {
        "mercedes.vehicle.tyres.front_left_pressure",
    ...
    {
        "mercedes.vehicle.tyres.front_right_pressure",
    ...
    {
        "mercedes.vehicle.tyres.rear_left_pressure",
    ...
    {
        "mercedes.vehicle.tyres.rear_right_pressure",
    ...
    {
        "mercedes.vehicle.warning.coolant_level_low",
    ...
    {
        "mercedes.vehicle.warning.brake_fluid",
        "Brake fluid warning",
        "Mercedes backend semantic / cross-model research target",
        MBLINK_MERCEDES_MODULE_OTHER,
        MBLINK_MERCEDES_DID_LAB_CONCEPT_ONLY,
        false, 0U, 0U, MBLINK_MERCEDES_DID_LAB_UNSIGNED_BIG_ENDIAN,
        0.0, 0.0, "bool",
        "mercedes.backend.warning_brake_fluid",
        "Mercedes MBSDK proves this backend semantic exists in the connected-vehicle model. Exact ECU, protocol mapping, DID, encoding and model/year applicability remain intentionally unmapped.",
        "https://github.com/mercedes-benz/MBSDK-CarKit-iOS/blob/master/MBCarKit/MBCarKit/Models/DTO/VehicleStatusDTO.swift"
    },
    {
        "mercedes.vehicle.warning.brake_lining",
        ...
        false, 0U, 0U, MBLINK_MERCEDES_DID_LAB_UNSIGNED_BIG_ENDIAN,
        0.0, 0.0, "bool",
        "mercedes.backend.warning_brake_lining",
        "Mercedes MBSDK proves this backend semantic exists in the connected-vehicle model. Exact ECU, protocol mapping, DID, encoding and model/year applicability remain intentionally unmapped.",
        "https://github.com/mercedes-benz/MBSDK-CarKit-iOS/blob/master/MBCarKit/MBCarKit/Models/DTO/VehicleStatusDTO.swift"
    },
    {
        "mercedes.vehicle.warning.engine_light",
